# -*- coding: utf-8 -*-
# @Time    : 2019-07-25 09:41
# @Author  : Yuyoo
# @Email   : sunyuyaoseu@163.com
# @File    : run_pretraining.py.py
...
from utils import Voc, metric_report, t2n, get_n_params
from config import BertConfig
from models.predictive_models import GBERT_Pretrain
...
def load_dataset(args):
    ...
    def load_ids(data, file_name):
        ...
        :param file_name:
        :return: raw data form, tokenizer,
                single_visit+multi_visit[train_id]
                multi_visit[eval_id]
        """
        ids = []
...
def main():
    ...
    parser.add_argument("--train_file", default='data-single-visit.pkl', type=str, required=False,
